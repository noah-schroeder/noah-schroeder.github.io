...
<script>
    async function loadPublications() {
        try {
            const response = await fetch('scholar_all_publications.json');
            const data = await response.json();
                ...
                publicationsContainer.innerHTML = data.publications
                    ...
                    .map(pub => `
                        <div class="publication-item">
                            ...
                            <div class="publication-citation">${pub.citation}</div>
            ...
            updateInfo.textContent = `Last updated: ${lastUpdated.toLocaleDateString()} ${lastUpdated.toLocaleTimeString()}`;
            publicationsContainer.prepend(updateInfo);
